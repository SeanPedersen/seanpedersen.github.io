...
Increase your freedom and [remove the digital leeches](/posts/google-ejector) like Google and co, invest into privacy respecting software that works offline and ideally is open-source. Export your personal data from the data kraken like Google, Meta and co and delete your accounts to stop feeding these privacy invading operations. Embrace software that lets you own your data.

Long live the file - download your favorite music, images, blog articles and videos.

Tools to download files:
- [InterPlanetary File System](/posts/ipfs)
