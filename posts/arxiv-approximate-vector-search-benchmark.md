...
|---|---:|---:|---:|---:|---:|---:|
| NumPy full linear scan | 0.0 s | 1.000 | 6.38 ms | 12.55 ms | 0 B | 248.9 MiB |
...
|---|---|---:|---:|
| NumPy full linear scan | Exact scan of filtered vectors | 1.000 | 1.23 ms |
...
- checkout: https://github.com/datastax/jvector
