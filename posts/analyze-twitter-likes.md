...
Just import the created twitter-likes directory containing your likes as text files using [Digger Solo](https://digger.so/o) and dig in! Use the powerful search to find specific tweets or use the semantic data map to freely explore all of your likes clustered by content similarity.
