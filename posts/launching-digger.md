...
There is a [desktop version](https://digger.so/?desktop=true) and a [mobile version](https://grid.digger.so/). The desktop version provides a global overview. The mobile version is more limited in the global expressivenes but visually not as overwhelming.
