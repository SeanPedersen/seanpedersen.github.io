...
Rust is a statically and strongly typed systems programming language that enforces memory safety (without a garbage collector) through its ownership and borrowing model.
...
Rust also shines through its ergnomic package manager cargo that provides a smooth developer UX.
