...
Per file scoping, should we make it impossible that two agents run at once that edit same file/s? or just use agent email and let the agents coordinate their file access?
