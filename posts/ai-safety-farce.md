...
If these companies were truly interested in developing safe AI for humanity they would not build this LLM powered mass manipulation system but instead invest heavily into safe AI deployment via decentral and private LLM inference (using on-device inference or [homomorphic encryption](https://en.wikipedia.org/wiki/Homomorphic_encryption)). Only this way can AI be used without enabling mass surveillance and manipulation.
