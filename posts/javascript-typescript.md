...
Use [React](https://react.dev/learn) for a popular framework, with many resources (both knowledge and developers) available. Use [Svelte](https://svelte.dev/), [Solid](https://www.solidjs.com/) or [Marko](https://markojs.com/) for smaller and better alternatives. Read [this article](https://www.lorenstew.art/blog/10-kanban-boards/) for an excellent comparison of frontend state management frameworks.
