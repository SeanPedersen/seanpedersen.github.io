...
A magnet creates a [magnetic field](https://en.wikipedia.org/wiki/Magnetic_field) around itself. The field assigns a direction and strength to each point in space. It tells us how a moving electric charge or another magnetic object will respond there.
...
A compass needle turns because the field exerts a torque on its [magnetic dipole](https://en.wikipedia.org/wiki/Magnetic_dipole). The needle settles in the direction that gives it lower energy. Two magnets attract or repel because their fields and dipoles seek a lower-energy arrangement.
...
Exchange is not a new force. It comes from the electric repulsion between electrons plus two quantum rules. Identical electrons share a joint wave function, and the [Pauli exclusion principle](https://en.wikipedia.org/wiki/Pauli_exclusion_principle) limits which states they may share.
...
At a material's [Curie temperature](https://en.wikipedia.org/wiki/Curie_temperature), long-range ferromagnetic order disappears. Above that point, the material becomes paramagnetic. An applied field can still produce a weak alignment, but the material no longer sustains its own bulk magnetization.
...
Below a critical temperature, a superconductor carries direct current with zero resistance. It also expels magnetic flux from its interior through the [Meissner effect](https://en.wikipedia.org/wiki/Meissner_effect). Currents near its surface create a field that opposes the applied field.
...
In conventional superconductors, lattice vibrations help electrons form [Cooper pairs](https://en.wikipedia.org/wiki/Cooper_pair). Many pairs enter one coherent quantum state. A disturbance must break or excite that state before it can dissipate current.
...
2. [OpenStax: Electron Spin](https://openstax.org/books/university-physics-volume-3/pages/8-3-electron-spin)
3. [Ferromagnetism](https://farside.ph.utexas.edu/teaching/sm1/Thermalhtml/node89.html)
4. [OpenStax: Magnetic Fields Produced by Currents](https://openstax.org/books/college-physics-2e/pages/22-9-magnetic-fields-produced-by-currents-amperes-law)
5. [Physics Van: What Heating Does to a Magnet](https://van.physics.illinois.edu/ask/listing/2744)
6. [US Department of Energy: Superconductivity](https://www.energy.gov/science/doe-explainssuperconductivity)
7. [OpenStax: Superconductivity](https://openstax.org/books/university-physics-volume-3/pages/9-8-superconductivity)
